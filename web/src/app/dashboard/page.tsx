  ...
  return (
    <div className="flex flex-col items-center my-40 w-full min-h-screen">
      {isLogged ? (
        ...
        <div className="flex items-center flex-col gap-2 w-full max-w-xs">
          <p className="text-seccondaryText text-center">
            Only administrators are allowed to visit this page.
          </p>
          <div className="flex flex-col items-center gap-1 mt-4 ">
            <Link
              className="font-medium hover:text-primaryColor transition-all duration-500 ease-in-out flex flex-col items-center"
              href="/"
            >
              Back to home
            </Link>
